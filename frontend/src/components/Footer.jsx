...
//                     <a href="#" className="text-gray-600 hover:text-blue-500 transition"><i className="fab fa-facebook text-xl"></i></a>
//                     <a href="#" className="text-gray-600 hover:text-blue-500 transition"><i className="fab fa-twitter text-xl"></i></a>
//                     <a href="#" className="text-gray-600 hover:text-blue-500 transition"><i className="fab fa-linkedin text-xl"></i></a>
//                     <a href="#" className="text-gray-600 hover:text-blue-500 transition"><i className="fab fa-instagram text-xl"></i></a>
//                 </div>
//             </div>
//         </div>
