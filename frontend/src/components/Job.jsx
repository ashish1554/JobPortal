...
//   // const jobId="akhjkdkjaklalajlkejij"
...
//   }
//   return (
//     <div className="flex flex-col shadow-xl mt-8 border-2 h-[330px] w-[380px] rounded-md p-5 gap-2 transition-all duration-300 hover:scale-105 hover:-translate-y-2">
...
//         <img className="w-10 h-10 rounded-full" src={job?.company?.logo} alt="" />
...
//       </div>
//       <div>
//         <p className="text-gray-900 text-xl font-bold w-full">{job?.title}</p>
//         <p>{job?.description}</p>
//       </div>
//         <div className='flex gap-2'>
...
//         <button onClick={()=>navigate(`/description/${job?._id}`)} className="bg-gray-300 text-black px-3 py-2 rounded-md">Details</button>
//         <button className="bg-primary text-white px-3 py-2 rounded-md">Save For Later</button>
//     </div>
//     </div>
//   );
// };
...
const Job = ({ job }) => {
  ...
  return (
    // ✅ Outer wrapper to make cards flow side-by-side {/* 🔽 Your Original Card (UNCHANGED) */}
